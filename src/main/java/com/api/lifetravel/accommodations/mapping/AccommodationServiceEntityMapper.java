...
@Component
@AllArgsConstructor
public class AccommodationServiceEntityMapper implements Serializable {
    ...
    public AccommodationServiceEntityMapper accommodationMapper() { return new AccommodationServiceEntityMapper(modelMapper); }
