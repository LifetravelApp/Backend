...
@Component
@AllArgsConstructor
public class AccommodationConditionMapper implements Serializable {
    ...
    public AccommodationConditionMapper accommodationMapper() { return new AccommodationConditionMapper(modelMapper); }
