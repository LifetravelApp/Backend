...
public class TourMapper implements Serializable {
    ...
    public TourMapper transportMapper() { return new TourMapper(modelMapper); }
    ...
    public TourResource toResource(Tour transport) {
        return modelMapper.map(transport, TourResource.class);
    }
}
