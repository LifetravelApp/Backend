...
public class TourImageMapper implements Serializable {
    ...
    private static final long serialVersionUID = 1L;
     ...
     public TourImageMapper reviewMapper() {
         return new TourImageMapper(modelMapper);
     }
    ...
    public TourImage toModel(CreateTourImageResource resource) { return modelMapper.map(resource, TourImage.class);}
